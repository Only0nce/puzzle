        ...
        case 'p33':
          ...
          if (check_win()) {
            setTimeout(function() {
              ...
              document.getElementById('tab-grid').style.background = 'url("success.gif")';
              $.post("http://localhost/minigame/game.php", {everything: "google"}, function(result) {
                console.log(result)
              });
              setTimeout(back_to_normal , 1000);
            }, 500)
          }
          break;
      }
